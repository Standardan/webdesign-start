...
6. **One leading motion per viewport:** one lead (the scrolling phone, the generative poster), a few mid (clock, equalizer), the rest near-still (`craft.md` §10).
